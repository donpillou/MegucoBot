...
public:
  ...
  public:
    virtual ~Broker() {}
    virtual bool_t buy(double price, double amount, timestamp_t timeout, uint32_t* id = 0) = 0;
    virtual bool_t sell(double price, double amount, timestamp_t timeout, uint32_t* id = 0) = 0;
